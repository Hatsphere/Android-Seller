...
public class Order {
    ...
    public Order(String mProductName, String mProductPrice, int mTypeOfRequest, String mAccept,
                 String mReject, int mNumOfRequest, String mNum, int mProductImageResourceId) {
